	loan.invite = loan.invite || {
	sell_sellorderquery : function() {
		var inviterMobile = $("#inviterMobile").val();
		var invitCount = $("#invitCount").val();
		var sucCount = $("#sucCount").val();
		var totalAcount = $("#totalAcount").val();

		$("#lendGridId").jqGrid("setGridParam", {   
			postData:{'inviterMobile':inviterMobile,'invitCount':invitCount,'sucCount':sucCount,
	...
	exportLend:function(menuId){
		...
		window.location.href = loan.basePath + "/invite/exportCount?inviterMobile=" + inviterMobile;
	},
